                  ...
                  <div className="grid gap-4">
                    {achievements.map((achievement, index) => (
                      <motion.div
                        ...
                        className={`flex items-center space-x-4 p-4 rounded-lg border transition-all duration-200 ${achievement.earned
                          ? "border-primary/30 bg-primary/5"
                          : "border-border bg-muted/5 opacity-60"
                          }`}
                      >
                        <div className={`p-3 rounded-full ${achievement.earned
