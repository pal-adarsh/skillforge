...
import { Brain, BookOpen, Trophy, User, Menu, X, LogIn, LogOut, Gift, TrendingUp, Zap, Globe, Timer, FileText, FileUp, BookText } from "lucide-react";
...
export const Navigation = () => {
  ...
  const navItems = [
    ...
    { name: t.docs || "Docs", icon: BookText, path: "/docs" },
